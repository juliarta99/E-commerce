      ...
      <div class="w-full">
            <div class="w-full">
                <div class="flex items-center justify-center gap-4">
                      <button id="buttonBiodata" class="text-blue-500 border-b-2 border-blue-500" onclick="showMyBiodata()">
                            <h1 class="text-sm lg:text-md">Infomasi profile</h1>
                      </button>
                      <button id="buttonAlamat" class="border-b-2" onclick="showMyAlamat()">
            ...
            <div id="biodata" class="w-full mt-8">
                  <div class="flex w-50 sm:w-full">
                        <div class="mx-auto">
                              <button id="buttonUbahBiodata" class="p-2 px-4 mr-4 text-xs text-white bg-blue-500 rounded-md sm:text-sm" onclick="showUbahMyBiodata()">Ubah Profile</button>
                        ...
                        <div class="items-center justify-center w-full max-w-5xl mx-auto sm:flex">
                              <div class="w-full sm:w-1/2">
                                    @if (Auth::user()->image != null)
                                          <img src="{{ asset('storage/'. Auth::user()->image) }}" class="w-48 mx-auto rounded-full h-48 object-cover" alt="{{ Auth::user()->name }}">
                                    @else
                                          <img src="{{ asset('img/profile_default.png') }}" class="w-48 mx-auto rounded-full h-48 object-cover" alt="{{ Auth::user()->name }}">
                                    @endif
                              </div>
            ...
            <div id="alamat" class="hidden mt-8">
                  <div class="w-full">
                        <div class="flex w-50 sm:w-full">
                              <div class="mx-auto">
                                    <button id="buttonTambahAlamat" class="p-2 px-4 text-xs text-white bg-blue-500 rounded-md sm:text-sm" onclick="showTambahMyAlamat()">Tambah alamat</button>
                              </div>
                        </div>
                        <div id="showAlamat">
