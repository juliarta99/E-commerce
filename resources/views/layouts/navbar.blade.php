                  ...
                  @auth
                      <div class="flex items-center justify-center">
                        <div class="mr-2 cursor-pointer" id="toko">
                              ...
                              <div id="showToko" class="absolute hidden p-4 -translate-x-4 lg:translate-y-4 translate-y-20 bg-white rounded-md shadow-md">
                                    <h1 class="text-xs lg:text-sm">Toko belum dibuat!!</h1>
                                    <a href="/toko/create" class="text-blue-500 text-xs lg:text-sm">Buat Toko</a>
                              </div>                                  
                        </div>
                        <div class="flex items-center justify-center cursor-pointer" id="profile">
                              ...
                              <div id="show-profile" class="absolute hidden p-4 translate-y-36 bg-white rounded-md shadow-md lg:translate-y-24">
                                    <div class="mb-1">
