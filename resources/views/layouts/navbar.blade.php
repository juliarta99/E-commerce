<nav class="w-full shadow-sm fixed bg-white z-[999]">
      <div class="flex items-center justify-between py-4 px-9">
            <div id="logo" class="cursor-pointer">
                  <a href="/">
                        <h1 class="font-semibold text-blue-500 text-base sm:text-xl lg:text-2xl">E-commerce</h1>
                  </a>
            </div>
            ...
            <div class="flex">
                  <div class="flex items-center justify-center mr-4 border-r-2 border-r-gray-500">
                        <div class="mr-2 cursor-pointer">
                              <a href="/keranjang">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="{{ Request::is('keranjang') ? 'blue' : '#000' }}" class="w-4 h-4 sm:w-5 sm:h-5">
                        ...
                        {{-- @auth
                              <div class="mr-2 cursor-pointer">
                                    <a href="/notification">
                                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="{{ Request::is('notification') ? 'blue' : '#000' }}" class="w-4 h-4 sm:w-5 sm:h-5">
                              ...
                              <div class="mr-2 cursor-pointer">
                                    <a href="/chats">
                                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="{{ Request::is('chats') ? 'blue' : '#000' }}" class="w-4 h-4 sm:w-5 sm:h-5">
                  ...
                  @auth
                      <div class="flex items-center justify-center">
                        <div class="mr-2 cursor-pointer" id="toko" onclick="showToko()">
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="{{ Request::is('toko') ? 'blue' : '#000' }}" class="w-4 h-4 sm:w-5 sm:h-5">
                              ...
                              <div id="show-profile" class="absolute hidden p-4 w-max bg-white rounded-md shadow-md translate-y-36 lg:translate-y-24">
                                    <div class="mb-1">
                                          <a class="flex items-center" href="/editProfile">
                                                ...
                                                <p class="ml-2 text-xs lg:text-sm {{ Request::is('editProfile') ? 'text-blue-500' : '#000' }}">Edit Profile</p>
                                          </a>
                                    </div>
                                    <div class="mb-1">
                                          <a class="flex items-center" href="/alamat">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="{{ Request::is('alamat') ? 'blue' : '#000' }}" class="w-4 h-4">
                                                      <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
                                                      <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
                                                </svg>
                                                <p class="ml-2 text-xs lg:text-sm {{ Request::is('alamat') ? 'text-blue-500' : '#000' }}">Alamat</p>
                                          </a>
                                    </div>
                                    <div class="mb-1">
                                          <a class="flex items-center" href="{{ route('transaksi') }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="{{ Request::is('transaksi') ? 'blue' : '#000' }}" class="w-4 h-4">
                                                      <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
                                                </svg>
                                                <p class="ml-2 text-xs lg:text-sm {{ Request::is('transaksi') ? 'text-blue-500' : '#000' }}">Pembelian</p>
                                          </a>
                                    </div>
                                    <div class="mb-1">
                                          <a class="flex items-center" href="/favorit">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="{{ Request::is('favorit') ? 'blue' : '#000' }}" class="w-4 h-4">
                                                      <path stroke-linecap="round" stroke-linejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
                                                </svg>
                                                <p class="ml-2 text-xs lg:text-sm {{ Request::is('favorit') ? 'text-blue-500' : '#000' }}">Toko Favorit</p>
                                          </a>
                                    </div>
                                    <div class="mb-1">
                                          <a class="flex items-center" href="/logout">
                                                ...
                                                <p class="ml-2 text-xs lg:text-sm">Keluar</p>
                                          </a>
                                    </div>
                              </div>
                        </div>
                  ...
                  @guest
                        <div class="guest">
                              <a href="/login">
                                    <button class="text-xs md:text-sm px-2 py-1 md:px-4 md:py-2 border-2 border-blue-500 rounded-lg">Login</button>
                              </a>
                              <a href="/register">
                                    <button class="text-xs md:text-sm px-2 py-1 md:px-4 md:py-2 text-white bg-blue-500 rounded-lg">Register</button>
                              </a>
                        </div>
                  @endguest
            </div>
