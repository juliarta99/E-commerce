                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                            ...
                            <div class="w-full">
                                <a href="/toko/product/{{ $product->slug }}">
                                        <div class="grid grid-cols-1 md:grid-cols-1-2 lg:grid-cols-1 items-center w-full p-4 bg-white shadow-md">
                                            <div class="w-full">
                                                    <div class="relative">
                                            ...
                                            <div class="w-full px-4 md:w-1/2 lg:w-full mt-2">
                                                    ...
                                                    <div class="flex flex-wrap mt-2">
                                                        ...
                                                        @if (count($product->transaksis) == 0)
                                                            <form action="/toko/product/{{ $product->slug }}" onsubmit="return confirm('Apakah anda yakin ingin menghapus produk {{ $product->name }}?')" method="post">
                                                                @csrf
                                                                @method('delete')
                                                                <button type="submit">
