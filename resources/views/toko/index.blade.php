...
<div class="pt-24 pb-10 px-9 lg:pt-16">
    <div class="w-full">
        @if (Auth::user()->toko->approve == 0)
                <p class="text-center mt-5">Toko anda masih dalam proses pengecekan berkas</p>
        @else
                                    ...
                                    <div class="flex flex-wrap items-center w-full p-4 mb-4 bg-white shadow-md">
                                        ...
                                        <div class="w-full px-4 md:w-1/2 lg:w-full mt-2">
                                                ...
                                                <div class="flex flex-wrap mt-2">
                                                    ...
                                                    <form action="/toko/product/{{ $product->slug }}" onclick="return confirm('Apakah anda yakin ingin menghapus produk {{ $product->name }}?')" method="post">
                                                        @csrf
                                                        @method('delete')
                                                        <button type="submit">
