      ...
      <div class="pb-10 px-9 pt-36 lg:pt-24">
            <div class="w-full">
                  ...
                  <div class="relative w-full">
                        ...
                        <div class="absolute top-0 right-0 p-2 text-white bg-red-500 rounded-tr-sm">{{ $product->potongan }}%</div>
                  </div>
                  <div class="w-full mt-2">
                        <h1 class="text-xl font-semibold text-center text-black md:text-2xl lg:text-3xl xl:text-4xl">{{ $product->name }}</h1>
                  </div>
                  <div class="sticky w-full p-2 shadow-md">
                        <div class="flex justify-center gap-3 text-black bg-white">
                              <a href="">
                  ...
                  <div class="w-full mt-2" id="detail">
                  ...
                  <div class="w-full mt-4" id="ulasan">
