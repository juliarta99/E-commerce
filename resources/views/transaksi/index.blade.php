        ...
        @csrf
            <div class="mb-5">
                ...
                <div class="mt-2">
                    ...
                    <select name="tujuan" id="tujuan" class="bg-gray-200 @error('tujuan') border-2 border-red-500 @enderror w-full px-3 py-2 rounded-md">
                    ...
                    @enderror
                    <input type="radio" name="kurir" id="jne" value="jne" class="mt-2">
                    <label for="jne" class="mr-1">JNE</label>
                    <input type="radio" name="kurir" id="pos" value="pos">
                    <label for="pos" class="mr-1">Pos Indonesia</label>
                    <input type="radio" name="kurir" id="tiki" value="tiki">
            ...
            <div class="">
                ...
                <button class="mt-2 text-xs md:text-sm px-2 py-1 md:px-4 md:py-2 border-2 hover:border-blue-500 hover:bg-white bg-blue-500 transition-all rounded-lg">Lanjut Bayar</button>
            </div>
        </form>
    </div>
