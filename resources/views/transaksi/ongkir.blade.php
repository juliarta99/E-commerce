                                ...
                                @if ($ongkir['id_toko'] != $prevToko)
                                    ...
                                    <div class="flex gap-2">
                                        @foreach ($ongkir['results']['costs'] as $cost)
                                            <input type="radio" class="hidden" name="ongkir-{{ $ongkir['id_toko'] }}" id="ongkir-{{ $ongkir['id_toko']. '-' .$cost['service'] }}">
                                            <label for="ongkir-{{ $ongkir['id_toko']. '-' .$cost['service'] }}" class="bg-slate-200 p-2 rounded-md cursor-pointer">
                                                ...
                                                <p class="text-sm font-bold">{{ $cost['cost'][0]['value'] }}</p>
                                                <p class="text-sm">{{ $cost['cost'][0]['etd'] }}</p>
                                            </label>
                                        @endforeach
                                    </div>
