                        ...
                        <div class="w-full px-4 pt-4 pb-2">
                              <div class="flex items-center justify-between w-full ">
                                    <div class="flex items-center w-full">
                                          @if ($toko->image != null)
                                                <img src="storage/{{ $toko->image }}" class="w-10 h-10 rounded-full object-cover" alt="{{ $toko->name }}">
                                          @else
                                          ...
                                          <div class="ml-2">
                                                ...
                                                <div class="flex items-center">
                                                      ...
                                                      <p class="text-xs lg:text-sm">{{ $avgToko }}</p>
                                                </div>
                                          </div>
                                    </div>
                              </div>
                                    ...
                                    <a href="/product/{{ $product->slug }}">
                                          <div class="flex flex-wrap items-center w-full p-4 mb-4 bg-white shadow-md">
                                                ...
                                                <div class="w-full px-4 md:w-1/2 lg:w-full mt-2">
                                                      <h2 class="text-xs lg:text-sm font-bold text-black">{{ Str::limit($product->name, 15) }}</h2>
                                                      ...
                                                      <div class="flex items-center">
                                                            ...
                                                            <p class="text-xs">{{  $product->transaksis->avg('comment.rate') ? $product->transaksis->avg('comment.rate') : '0' }}</p>
                                                      </div>
