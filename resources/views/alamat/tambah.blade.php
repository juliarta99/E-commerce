...
<div id="formTambahAlamat">
    <form action="/alamat" method="post" class="flex flex-col max-w-md mx-auto mt-5">
            ...
            <input class="w-full px-4 py-2 text-sm bg-gray-200 rounded-md lg:text-base @error('penerima') border-2 border-red-500 @enderror" type="text" name="penerima" id="penerima" value="{{ old('penerima', Auth::user()->name) }}">
            @error('penerima')
            ...
            <input class="w-full px-4 py-2 text-sm bg-gray-200 rounded-md lg:text-base @error('kelurahan') border-2 border-red-500 @enderror" type="text" name="kelurahan" id="kelurahan" value="{{ old('kelurahan') }}">
            @error('kelurahan')
                <div class="w-full text-sm text-red-500 lg:text-base">{{ $message }}</div>
            @enderror
            <label class="mt-2 text-sm text-black lg:text-base" for="kecamatan">Kecamatan</label>
            <input class="w-full px-4 py-2 text-sm bg-gray-200 rounded-md lg:text-base @error('kecamatan') border-2 border-red-500 @enderror" type="text" name="kecamatan" id="kecamatan" value="{{ old('kecamatan') }}">
            @error('kecamatan')
                <div class="w-full text-sm text-red-500 lg:text-base">{{ $message }}</div>
            @enderror
            ...
            <input class="w-full px-4 py-2 text-sm bg-gray-200 rounded-md lg:text-base @error('detail') border-2 border-red-500 @enderror" type="text" name="detail" id="detail" value="{{ old('detail') }}">
            @error('detail')
                <div class="w-full text-sm text-red-500 lg:text-base">{{ $message }}</div>
            @enderror
            <label class="mt-2 text-sm text-black lg:text-base" for="catatan">Catatan</label>
            <input class="w-full px-4 py-2 text-sm bg-gray-200 rounded-md lg:text-base @error('catatan') border-2 border-red-500 @enderror" type="text" name="catatan" id="catatan" value="{{ old('catatan') }}">
