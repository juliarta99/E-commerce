    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
        <div class="rounded-md bg-slate-200 py-2 md:py-4 px-4 md:px-6 border-b-4 border-green-500">
            <div class="flex gap-3 md:gap-5 items-center h-full">
                ...
                <div class="mx-auto">
                    <h1 class="uppercase text-lg lg:text-xl xl:text-2xl text-center text-green-500 font-bold">9248</h1>
        ...
        <div class="rounded-md bg-slate-200 py-2 md:py-4 px-4 md:px-6 border-b-4 border-blue-500">
            <div class="flex gap-3 md:gap-5 items-center h-full">
                ...
                <div class="mx-auto">
                    <h1 class="uppercase text-lg lg:text-xl xl:text-2xl text-center text-blue-500 font-bold">9248</h1>
        ...
        <div class="rounded-md bg-slate-200 py-2 md:py-4 px-4 md:px-6 border-b-4 border-purple-500">
            <div class="flex gap-3 md:gap-5 items-center h-full">
                ...
                <div class="mx-auto">
                    <h1 class="uppercase text-lg lg:text-xl xl:text-2xl text-center text-purple-500 font-bold">9248</h1>
        ...
        <div class="rounded-md bg-slate-200 py-2 md:py-4 px-4 md:px-6 border-b-4 border-yellow-500">
            <div class="flex gap-3 md:gap-5 items-center h-full">
                ...
                <div class="mx-auto">
                    <h1 class="uppercase text-lg lg:text-xl xl:text-2xl text-center text-yellow-500 font-bold">9248</h1>
        ...
        <div class="rounded-md bg-slate-200 py-2 md:py-4 px-4 md:px-6 border-b-4 border-fuchsia-500">
            <div class="flex gap-3 md:gap-5 items-center h-full">
                ...
                <div class="mx-auto">
                    <h1 class="uppercase text-lg lg:text-xl xl:text-2xl text-center text-fuchsia-500 font-bold">9248</h1>
        ...
        <div class="rounded-md bg-slate-200 py-2 md:py-4 px-4 md:px-6 border-b-4 border-sky-500">
            <div class="flex gap-3 md:gap-5 items-center h-full">
                ...
                <div class="mx-auto">
                    <h1 class="uppercase text-lg lg:text-xl xl:text-2xl text-center text-sky-500 font-bold">9248</h1>
